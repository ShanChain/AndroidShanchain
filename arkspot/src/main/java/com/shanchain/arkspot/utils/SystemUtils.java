...
public class SystemUtils {
     ...
     *
     */
    public static boolean FlymeSetStatusBarLightModeWithWhiteColor(AppCompatActivity activity,Window window, boolean dark) {
        boolean result = false;
        if (window != null) {
            try {
                WindowManager.LayoutParams lp = window.getAttributes();
        ...
        if (result){
            setImmersiveStatusBar_API21(activity,Color.WHITE);
        }else {
     ...
     *
     */
    public static boolean MIUISetStatusBarLightModeWithWhiteColor(AppCompatActivity activity,Window window, boolean dark) {
        boolean result = false;
        if (window != null) {
            Class clazz = window.getClass();
            try {
