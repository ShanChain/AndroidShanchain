...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context, R.drawable.ic_pulltorefresh_arrow);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context, R.mipmap.abs_home_btn_fulltext_default);
        }
