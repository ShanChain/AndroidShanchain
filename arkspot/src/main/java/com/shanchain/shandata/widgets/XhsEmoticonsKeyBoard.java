...
import com.shanchain.shandata.widgets.recAudio.RecordVoiceButton;
...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    private RelativeLayout xhsEmoticon;
    ...
    protected void initEmoticonFuncView() {
        ...
        xhsEmoticon = findViewById(R.id.xhs_emoticon);
        inputJoin = findViewById(R.id.bt_chat_input_join);
    ...
    public RecordVoiceButton getBtnVoice() { return mBtnVoice; }

    public View getXhsEmoticon() { return xhsEmoticon; }

    public Button getInputJoin() { return inputJoin; }
