package com.shanchain.shandata.widgets.pickerimage.adapter;
...
import com.shanchain.shandata.widgets.pickerimage.fragment.PickerImageFragment;
import com.shanchain.shandata.widgets.pickerimage.model.PhotoInfo;
import com.shanchain.shandata.widgets.pickerimage.utils.PickerImageLoadTool;
import com.shanchain.shandata.widgets.pickerimage.utils.RotateImageViewAware;
import com.shanchain.shandata.widgets.pickerimage.utils.ScreenUtil;
import com.shanchain.shandata.widgets.pickerimage.utils.ThumbnailsUtil;
...
public class PickerPhotoAdapter extends BaseAdapter {
	...
	public void refreshView(int index) {
		...
		if (list.get(index).isChoose()) {
			...
			holder.select.setImageResource(R.drawable.picker_preview_unselected);
		}
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (list.get(position).isChoose()) {
			...
			viewHolder.select.setImageResource(R.drawable.picker_preview_unselected);
		}
