...
public class RichEditor extends AppCompatEditText {
    ...
    public RichEditor(Context context, AttributeSet attrs) {
        ...
        setFilters(filters);
        size = DensityUtils.dip2px(context, 20);
        initView();
    }
    ...
    private void initView() {
        ...
        this.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (listenerEnable){
                    texChanged(s,start,before,count);
                }else {
    ...
    public void texChanged(CharSequence s, int start, int before, int count) {
        mListener.textChange(s,start,before,count);
    }
