package com.shanchain.shandata.widgets.pickerimage;
...
import com.shanchain.shandata.widgets.pickerimage.adapter.PickerPreviewPagerAdapter;
import com.shanchain.shandata.widgets.pickerimage.model.PhotoInfo;
import com.shanchain.shandata.widgets.pickerimage.model.PickerContract;
import com.shanchain.shandata.widgets.pickerimage.utils.BitmapDecoder;
...
import com.shanchain.shandata.widgets.pickerimage.utils.PickerUtil;
import com.shanchain.shandata.widgets.pickerimage.utils.RequestCode;
import com.shanchain.shandata.widgets.pickerimage.view.BaseZoomableImageView;
import com.shanchain.shandata.widgets.pickerimage.view.ToolBarOptions;
import com.shanchain.shandata.widgets.pickerimage.view.UIView;
import com.shanchain.shandata.widgets.pickerimage.view.ViewPagerFixed;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.picker_image_preview_photos_select) {
            ...
            if (selectPhotoList != null && selectPhotoList.size() == 0) {
                ...
                ToastUtils.showToast(PickerAlbumPreviewActivity.this, "请至少选择一张发送");
            }else {
