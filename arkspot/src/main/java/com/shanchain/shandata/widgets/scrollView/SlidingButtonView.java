package com.shanchain.shandata.widgets.scrollView;
...
public class SlidingButtonView extends HorizontalScrollView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            //只需要执行一次
            mTextView_Delete = (TextView) findViewById(R.id.tv_item_dynamic_comment_delete);
            ViewGroup linearLayout = findViewById(R.id.iv_item_dynamic_comment_show);
            int height = mTextView_Delete.getMeasuredHeight();
            mTextView_Delete.setHeight(height);
//            mTextView_Delete
...
//            leftWidth = linearLayout.getWidth();
...
//                mIonSlidingButtonListener.setMenuCanTouch(this,isCanTouch());
...
//        LogUtils.d("leftWidth: " + leftWidth);
    ...
    public interface IonSlidingButtonListener {
        Boolean setMenuCanTouch(SlidingButtonView slidingButtonView,Boolean isTouch);
