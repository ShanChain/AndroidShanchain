package com.shanchain.shandata.widgets.takevideo;
...
import com.shanchain.shandata.widgets.takevideo.camera.CameraManager;
import com.shanchain.shandata.widgets.takevideo.camera.CameraProgressBar;
import com.shanchain.shandata.widgets.takevideo.camera.CameraView;
import com.shanchain.shandata.widgets.takevideo.camera.MediaPlayerManager;
import com.shanchain.shandata.widgets.takevideo.utils.FileUtils;
import java.io.File;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void initDatas() {
        ...
        if (camera.equals("takePhoto")){
            ...
            mProgressbar.setOnProgressTouchListener(new CameraProgressBar.OnProgressTouchListener() {
                ...
                public void onLongClick(CameraProgressBar progressBar) {
                    ToastUtils.showToast(CameraActivity.this,"点击拍摄照片");
                }
        ...
        }else if(camera.equals("takeVideo")) {
            mProgressbar.setOnProgressTouchListener(new CameraProgressBar.OnProgressTouchListener() {
                @Override
                public void onClick(CameraProgressBar progressBar) {
//                mTv_tack.setVisibility(View.GONE);
//                cameraManager.takePhoto(callback);
                    ToastUtils.showToast(CameraActivity.this,"长按拍摄视频");
                }
