...
public class TaskCommentAdapter extends BaseQuickAdapter<BdCommentBean, BaseViewHolder> implements SlidingButtonView.IonSlidingButtonListener {
    ...
    public TaskCommentAdapter(@LayoutRes int layoutResId, @Nullable List<BdCommentBean> data, Context mContext) {
...
/*        if (!isScroll) {
        ...
        slidingButtonView.setSlidingButtonListener(TaskCommentAdapter.this);
