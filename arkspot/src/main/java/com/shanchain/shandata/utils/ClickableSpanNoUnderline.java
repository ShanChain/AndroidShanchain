...
/**
 * Created by zhoujian on 2017/11/29.
 */
...
public class ClickableSpanNoUnderline extends ClickableSpan {
    ...
    private SpanBean clickData;

    public SpanBean getClickData() {
        return clickData;
    }

    public void setClickData(SpanBean clickData) {
    ...
    public void updateDrawState(@NonNull TextPaint ds) {
        ...
        //ds.bgColor = mPressed ?Color.GRAY : Color.WHITE;
        ds.clearShadowLayer();
    }
    ...
    public void setPresed(boolean isPressed){
        mPressed = isPressed;
    }
