//package com.shanchain.arkspot.rn;
//
...
//                switch (position) {
//                    case 0:
//                        setFragment(new RNStoryFragment());
//                        break;
//                    case 1:
//                        setFragment(new RNChatFragment());
//                        break;
//                    case 2:
//                        setFragment(new RNSquareFragment());
//                        break;
//                    case 3:
//                        setFragment(new RNMineFragment());
