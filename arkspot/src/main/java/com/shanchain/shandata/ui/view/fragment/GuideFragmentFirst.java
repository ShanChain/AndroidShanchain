...
public class GuideFragmentFirst extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_guide_first,null);
        return  mView;
    }
    ...
    public void onResume() {
        ...
        if(sta.equals("zh")){
            mLinearLayout.setBackgroundResource(R.mipmap.guide_first_new);
        }else {
            mLinearLayout.setBackgroundResource(R.mipmap.guide_first_en);
        }
    }
}
