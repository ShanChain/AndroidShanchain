...
public class MyReciverCouponFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener,
        CounponListView {
    ...
    //获取我领取的马甲券列表
    private void getMyReciverCouponList() {
        mPresenter.getMyGetCounponList(characterId,page,size,Constants.pullRefress);
    }
