...
//        registerMessageReceiver();
    ...
    private void initView() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MyMessagebackActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void initRecyclerView() {
        ...
        View headView = LayoutInflater.from(MyMessagebackActivity.this).inflate(R.layout.item_msg_home, null, false);
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                if (MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
                    ...
                    ToastUtils.showToast(MyMessagebackActivity.this, showMsg.toString());
