...
public class ThemeConfig implements Serializable{
    ...
    public static ThemeConfig DARK = new ThemeConfig.Builder()
            .setTitleBarBgColor(Color.rgb(0x38, 0x42, 0x48))//标题栏文本字体颜色
            .setFabNornalColor(Color.rgb(0x38, 0x42, 0x48))//设置Floating按钮Nornal状态颜色
            .setFabPressedColor(Color.rgb(0x20, 0x25, 0x28))//设置Floating按钮Pressed状态颜色
            .setCheckSelectedColor(Color.rgb(0x38, 0x42, 0x48))//选择框选中颜色
            .setCropControlColor(Color.rgb(0x38, 0x42, 0x48))//设置裁剪控制点和裁剪框颜色
