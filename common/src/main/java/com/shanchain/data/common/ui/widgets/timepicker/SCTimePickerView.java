package com.shanchain.data.common.ui.widgets.timepicker;
...
public class SCTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public SCTimePickerView(Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = com.bigkoo.pickerview.R.layout.pickerview_time;
        private CustomListener customListener;
        ...
        public SCTimePickerView build() {
            return new SCTimePickerView(this);
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_CANCEL)){
            mCancelClickListener.onCancelClick(v);
        }
        dismiss();
    }
