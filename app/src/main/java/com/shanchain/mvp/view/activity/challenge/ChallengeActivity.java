...
public class ChallengeActivity extends BaseActivity implements ArthurToolBar.OnLeftClickListener {
    ...
    @OnClick({R.id.iv_challenge_icon1, R.id.iv_challenge_icon2, R.id.tv_challenge_more, R.id.iv_challenge_happy_counts, R.id.iv_challenge_focuson_counts, R.id.iv_challenge_walk_counts, R.id.iv_challenge_sleep_counts, R.id.btn_challenge_new})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_challenge_walk_counts:
                readyGo(WalkMoreActivity.class);
                break;
