package com.shanchain.widgits.toolBar;
...
//        ViewCompat.setElevation(this, mResources.getDimension(R.dimen.arthur_navigation_elevation));
    ...
    private void initView(){
        ...
        mImmersiveView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,mResources.getDimensionPixelSize(R.dimen.arthur_navigation_icon)));
