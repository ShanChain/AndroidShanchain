...
public class FoundNightMarketAdapter extends BaseCommonAdapter<FoundNightMarketInfo> {

    public FoundNightMarketAdapter(Context context, int layoutId, List<FoundNightMarketInfo> datas) {
