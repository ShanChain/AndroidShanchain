...
import com.shanchain.shandata.adapter.CommentsAdapter;
import com.shanchain.shandata.adapter.NineGridDetailsAdapter;
...
public class DetailsActivity extends BaseActivity implements ArthurToolBar.OnLeftClickListener, ArthurToolBar.OnRightClickListener, View.OnClickListener {
    ...
    public void onRightClick(View v) {
        CustomDialog dialog = new CustomDialog(this, true,true, 1, R.layout.pop_report, new int[]{R.id.btn_pop_report, R.id.btn_pop_cancle});
